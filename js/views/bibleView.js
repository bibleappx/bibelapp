...
export function renderVerseDetailView(bookNumber, chapter, verseNum) {
    ...
    <div id="main-verse-display" class="card mb-4 main-verse-card">
        <div class="card-body">
            <p class="main-verse">
                <strong>${verseString}</strong> ${formatVerseText(verseTextOnly, bookNumber)}
            </p>
            <hr>
        ...
        <div class="card-header d-flex justify-content-between align-items-center">
            ...
            <div class="d-flex align-items-center gap-2">
                <div class="context-controls d-flex gap-1 mb-0">
                    ...
                    <button class="load-context-btn btn-icon" id="reset-context-btn" style="display: none;" title="Auf Standard zurücksetzen" data-direction="reset"><i class="fa-solid fa-rotate-left"></i></button>
